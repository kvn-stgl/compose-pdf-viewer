    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/kvnstgl/composepdfviewer/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/kvnstgl/composepdfviewer.git")
                    developerConnection.set("scm:git:ssh://github.com/kvnstgl/composepdfviewer.git")
                    url.set("https://github.com/kvnstgl/composepdfviewer/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/kvnstgl/composepdfviewer/issues")
                }
            }
        }
    }
